...
<div class="col-xs-12">
    ...
    <form class="form-horizontal" id="form" role="form" action="{{route('banner.store')}}">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <div class="upload-plus" data-field="image" data-upurl="{{route('upload',['file_name'=>'banner'])}}" data-token="{{csrf_token()}}" data-multiple="false">
