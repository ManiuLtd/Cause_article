...
<div class="col-xs-12">
    ...
    <form class="form-horizontal" id="form" role="form" action="{{route('photo_type.store')}}">
        {{csrf_field()}}

        <div class="form-group">
            <label class="col-sm-1 control-label no-padding-right"> 类型名称 </label>
            <div class="col-sm-9">
                <input type="text" name="name" class="col-xs-10 col-sm-5" data-rule="*" data-errmsg="类型名称不可为空"/>
