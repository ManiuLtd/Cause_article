...
<body>
<div id="mesag" class="flexv wrap mescroll">
...
<script>
    //下拉分页
    var mescroll = new MeScroll("mesag", { //第一个参数"mescroll"对应上面布局结构div的id
    ...
    function upCallback(page) {
        var url = "{{ route('message_list', request()->type) }}"+"?page="+page.num;
        $.ajax({
